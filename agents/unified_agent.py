...
def run_unified_agent(home_name: str, away_name: str, round_info: str, session_id: str) -> dict:
    ...
    # record_prediction now returns the server-assigned record_id, which the
    # order record must reference as its upstream_record_id — the ledger
    # rejects a client-generated ID here since prediction records get a
    # fresh server ID tied to the real Polymarket market binding.
