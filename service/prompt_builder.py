...
TACTICS_PROMPT_TEMPLATE = """You are a football tactical analyst. Your job is to analyse HOW two teams are set up and identify tactical advantages, mismatches, and vulnerabilities. You do NOT predict probabilities — that is someone else's job.
...
def build_tactics_prompt(
    ...
    prompt = TACTICS_PROMPT_TEMPLATE.format(
        home_name=home_name,
        away_name=away_name,
